  ...
  const drawer = (
    <>
      ...
      <List sx={{ paddingX: "30px" }}>
        <Typography variant="h6" marginBottom="20px" fontFamily="Arial">MENU</Typography>
        {menuConfigs.main.map((item, index) => (
          ...
          >
            ...
            <ListItemText
              disableTypography
              primary={
                <Typography textTransform="uppercase" fontFamily="Arial">
                  {item.display}
                </Typography>
              }
            />
        ...
        {user && (
          <>
            <Typography variant="h6" marginBottom="20px" fontFamily="Arial">PERSONAL</Typography>
        ...
        <Typography variant="h6" marginBottom="20px" fontFamily="Arial">THEME</Typography>
